...
public class EarthquakeCityMap extends PApplet {
	...
	private void selectMarkerIfHover(List<Marker> markers) {
		...
		// AbstractMarker
		// isInside( UnfoldingMap m, float x, float y ) ;
	...
	public void mouseClicked() {
		...
		// this one handles the initial click on the map
		// i think it would also handle multiple clicks on map
	...
	private void unhideCityMarkers() {
		...
		// System.out.println("Threat:" + em.threatCircle() );
		for (Marker marker : cityMarkers) {
	...
	private void unhideEarthQuakeMarkers() {
