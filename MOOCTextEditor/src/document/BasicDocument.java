...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> NumWordTokens = getTokens("[a-zA-Z]+");
	    return NumWordTokens.size();
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		List<String> NumSentenceTokens = getTokens("[^.!?]+");
	    return NumSentenceTokens.size();
	}
	...
	public int getNumSyllables()
	{
		...
		List<String> NumWordTokens = getTokens("[a-zA-Z]+");
		int i = 0;
		for(String wrd : NumWordTokens ){
			i += countSyllables(wrd);
		}
