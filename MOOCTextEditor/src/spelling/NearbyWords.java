...
return the list of real words
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		String curr;
		List<String> neighborList = new LinkedList<String>();
		...
		while((retList.size() < numSuggestions) &&
			...
			curr = queue.remove(0);
			neighborList = distanceOne(curr,true);
			for (int i = 0; i < neighborList.size() && (retList.size() < numSuggestions); i++){
				String n = neighborList.get(i);
